...
import { MessageOptions, MessageType, WALocationMessage, WAContactMessage, WAContactsArrayMessage, WATextMessage, WAMessageContent, WAMessage, WAMessageProto, MediaConnInfo, WAMediaUpload } from './Constants';
...
export declare class WAConnection extends Base {
     ...
     */
    sendMessage(id: string, message: string | WATextMessage | WALocationMessage | WAContactMessage | WAContactsArrayMessage | WAMediaUpload, type: MessageType, options?: MessageOptions): Promise<WAMessageProto.WebMessageInfo>;
    /** Prepares a message for sending via sendWAMessage () */
    prepareMessage(id: string, message: string | WATextMessage | WALocationMessage | WAContactMessage | WAContactsArrayMessage | WAMediaUpload, type: MessageType, options?: MessageOptions): Promise<WAMessageProto.WebMessageInfo>;
    /**
    ...
    prepareMessageContent(message: string | WATextMessage | WALocationMessage | WAContactMessage | WAContactsArrayMessage | WAMediaUpload, type: MessageType, options: MessageOptions): Promise<WAMessageProto.Message>;
